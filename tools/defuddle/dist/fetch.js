...
async function fetchPage(targetUrl, userAgent, language) {
    ...
    try {
        ...
        // Node's native fetch() wraps low-level network errors (DNS, TLS,
        // connection refused) in a generic "fetch failed" TypeError, with the
        // real reason nested in err.cause. Surface it so the CLI doesn't just
        // print the useless "fetch failed" message.
